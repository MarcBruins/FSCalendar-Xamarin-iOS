...
interface FSCalendarWeekdayView
{
    ...
    NSHashTable<UILabel> WeekdayLabels { get; }
...
interface FSCalendarDataSource
{
    ...
    [return: NullAllowed]
    UIImage Calendar (FSCalendar calendar, NSDate date);
    ...
    FSCalendarCell Calendar (FSCalendar calendar, NSDate date, FSCalendarMonthPosition position);
    ...
    nint Calendar (FSCalendar calendar, NSDate date);
    ...
    bool Calendar (FSCalendar calendar, NSDate date);
}
...
interface FSCalendarDelegate
{
    ...
    bool Calendar (FSCalendar calendar, NSDate date, FSCalendarMonthPosition monthPosition);
    ...
    void Calendar (FSCalendar calendar, NSDate date, FSCalendarMonthPosition monthPosition);
    ...
    void Calendar (FSCalendar calendar, NSDate date);
    ...
    void Calendar (FSCalendar calendar, CGRect bounds, bool animated);
    ...
    void Calendar (FSCalendar calendar, FSCalendarCell cell, NSDate date, FSCalendarMonthPosition monthPosition);
...
interface FSCalendarDelegateAppearance
{
    ...
    [return: NullAllowed]
    UIColor Calendar (FSCalendar calendar, FSCalendarAppearance appearance, NSDate date);
    ...
    CGPoint Calendar (FSCalendar calendar, FSCalendarAppearance appearance, NSDate date);
    ...
    nfloat Calendar (FSCalendar calendar, FSCalendarAppearance appearance, NSDate date);
    ...
    [return: NullAllowed]
    NSObject[] Calendar (FSCalendar calendar, FSCalendarAppearance appearance, NSDate date);
    ...
    FSCalendarCellShape Calendar (FSCalendar calendar, FSCalendarAppearance appearance, NSDate date);
}
